...
<table style="width:90%">
 ...
 <tbody>
	...
	<td> | <a class="btn btn-danger" href="deletehouseholdlist.php?id=<?php echo $information['person_id']; ?>">Delete</i></a>
		</td>
	<td> | 
    <a class="btn btn-success" href="edithousehold.php?edit_id=<?php echo $information['person_id']; ?>">Edit</i></a>
		</td>
