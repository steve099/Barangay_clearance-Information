...
$mysqli = new mysqli('localhost','root','','barangay') or die(mysqli_connect_error($mysqli));
...
$sql = "UPDATE INTO `brg_officer` (`officer_id`, `lastname`, `firstname`, `middlename`, `position`) VALUES ('$officer_id', '$lastname', '$firstname', '$middlename', '$position');";
